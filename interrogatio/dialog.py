...
from prompt_toolkit.layout import HSplit, HorizontalAlign, Layout
...
def show_dialog(questions, title, confirm, cancel):  # noqa: CCR001
    handlers = []
    layouts = []
    for q in questions:
            ...
            if not handler.is_valid():
                for msg in handler.errors:
                    validation_errors.append(
                        f'{handler.get_variable_name()}: {msg}',
                    )
